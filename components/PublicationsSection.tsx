...
import { BookOpen, GraduationCap, ShieldCheck, CheckCircle2 } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {RESUME_DATA.publications.map((pub, idx) => (
              <motion.div
                ...
                className="p-5 rounded-xl bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/80 space-y-2"
              >
                <div className="flex items-center justify-between gap-2">
                  <span className="px-2 py-0.5 rounded text-[10px] font-mono font-medium uppercase tracking-wider bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300">
