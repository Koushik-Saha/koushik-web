      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <div className="space-y-8 relative before:absolute before:inset-0 before:left-3 sm:before:left-4 before:w-0.5 before:bg-zinc-200 dark:before:bg-zinc-800">
          {RESUME_DATA.experience.map((item, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute left-1.5 sm:left-2.5 top-1.5 w-3 h-3 rounded-full bg-zinc-900 dark:bg-white ring-4 ring-white dark:ring-[#080808] group-hover:bg-emerald-500 transition-colors" />

              <div className="p-5 sm:p-6 rounded-xl bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/80 hover:border-zinc-400 dark:hover:border-zinc-700 transition-all">
                {/* Role Header */}
